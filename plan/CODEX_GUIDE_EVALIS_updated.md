...
Evalis е backend-first MVP за училищна система за оценяване, която постепенно се разширява с:
- learning / lessons модул
- private tutoring workspace
- gamification и reputation механики
...
- следващо разширение: уроци, частни групи, learning progress, engagement системи
...
### 4.8 Lessons domain boundary
- `Lesson` не е `Assessment`
- урокът е учебно съдържание и прогрес
- урокът може да има link към тест, но не наследява exam session lifecycle

### 4.9 Private tutoring boundary
- private tutoring режимът е отделен от institutional mode
- teacher може да добавя и управлява private ученици само във private workspace
- school admin правилата за класове и глобални връзки не се нарушават от private режима

### 4.10 Gamification boundary
- gamification точки и рейтинги не са равни на официални оценки
- reputation за teacher / institution не трябва да се базира само на количество съдържание
- quality, usage и ratings трябва да тежат повече от raw count
...
- границата между institutional mode и private mode
- границата между assessment domain и lesson domain
...
6. Как да се тества?
7. Попадам ли в assessment domain, lesson domain или private tutoring domain?
8. Има ли риск да смеся official grading с gamification логика?
...
- lesson vs assessment modeling
- institutional vs private tutoring boundaries
- gamification design and fairness
...
- подпомагане при създаване на уроци и учебни материали

### Но:
- учителят остава крайният авторитет
- AI не трябва самостоятелно да публикува въпроси или уроци без teacher confirmation
...
- AI should assist question and lesson creation, not redefine domain rules
...
- lesson assignment
- lesson progress
- linked practice / test after lesson

### P2 private tutoring
- teacher-managed private groups
- private student invitations
- private lesson/test assignment
- strict separation from institutional school structure
...
### P3 reputation and advanced browser control
- teacher reputation from public content quality
...
След това най-смисленото ново продуктово разширение е:
...
- смесване на school и private logic в едни и същи endpoints без ясна граница
- смесване на lesson progress с grading state
...
### Ако задачата е за нов модул
Изрично уточни:
- дали е assessment module, lesson module или private tutoring module
- дали има влияние върху official grading
- дали засяга gamification, reputation или само core domain
